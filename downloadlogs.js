...
(function () {   //variables you might actually want to change
    ...
    function generatelog(mjslog) {
        ...
        mjslog.forEach((e, leafidx) => {
            switch (e.constructor.name) {
                case "RecordNewRound": {   //new round
                    kyoku.init(e);
                    return;
                }
                case "RecordDiscardTile": {   //discard - marking tsumogiri and riichi
                ...
                case "RecordDealTile": {   //draw - after kan this gets passed the new dora
                    if (e.doras && e.doras.length > kyoku.doras.length)
                        kyoku.doras = e.doras.map(f => tm2t(f));
                ...
                case "RecordChiPengGang": {   //call - chi, pon, daiminkan
                    switch (e.type) {
                        case 0: {   //chii
                ...
                case "RecordAnGangAddGang" : {   //kan - shouminkan 'k', ankan 'a'
                ...
                case "RecordBaBei" : {   //kita - this record (only) gives {seat, moqie}
